...
?>
			...
			<tr>
				...
				<td nowrap colspan="4" style="text-align:right"><br/>
                                        ...
                                        <input class="btn btn-primary" onclick="submitbutton('save');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_SAVE'); ?>"/>
					&nbsp;&nbsp;
                                        <input class="btn btn-primary" onclick="submitbutton('instpackage');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_PKGINSTLR'); ?>"/>
                                        &nbsp;&nbsp;
                                        <input class="btn btn-primary" onclick="submitbutton('makepackage');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CREAPKG'); ?>"/>
					&nbsp;&nbsp;
                                        <input class="btn btn-primary" onclick="submitbutton('cancel');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CANCEL'); ?>"/>
...
?>
			...
			<tr>
				...
				<td nowrap colspan="2" style="text-align:right">
                                        <input class="btn btn-primary" onclick="submitbutton('mkpackage');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CONTINUE'); ?>"/>
					&nbsp;&nbsp;
                                        <input class="btn btn-primary" onclick="submitbutton('edit');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CANCEL'); ?>"/>
				</td>
				<td></td>
			</tr>
...
?>
			<tr>
				<td></td>
				<td nowrap colspan="2" style="text-align:right">
                                        <input class="btn btn-primary"  onclick="submitbutton('instpackage');" type="submit" value="<?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CLOSE'); ?>"/>
				</td>
				<td></td>
			</tr>
		</table>
